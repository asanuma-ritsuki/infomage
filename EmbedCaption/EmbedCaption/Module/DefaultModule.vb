...
Module DefaultModule
	...
	Public Sub OutputListLog(ByVal lstResult As ListBox, ByVal strOutputFolder As String, ByVal strSign As String, ByVal strSign2 As String)

		If Not System.IO.Directory.Exists(strOutputFolder) Then
			My.Computer.FileSystem.CreateDirectory(strOutputFolder)
		End If
		Dim strOutputFile As String = strOutputFolder & "\" & strSign & "_" & strSign2 & ".log"
