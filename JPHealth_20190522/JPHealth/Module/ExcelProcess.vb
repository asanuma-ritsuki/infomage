...
Module ExcelProcess
    ...
    Public Function WriteExcelFile(ByVal enumCategory As ExcelOutputCategory, ByVal strSaveFile As String, ByVal dt As DataTable, ByVal strOutputDate As String,
                                   ...
                                   Optional ByVal iTargetList As Integer = 0, Optional ByVal iCheckupCount As Integer = 0, Optional ByVal iLeafletCount As Integer = 0,
                                   Optional ByVal iLeafTotalCount As Integer = 0) As Boolean
                ...
                Case ExcelOutputCategory.WorkOrder
                    ...
                    For iHead As Integer = 0 To strHeads.Length - 1
                        ...
                        If Not blnData Then
                            ...
                            '2019/04/23
                            '３つ追加
                            sheet(iHead + 1, 16).Value = ""
                            sheet(iHead + 1, 17).Value = ""
                            sheet(iHead + 1, 18).Value = ""
                        End If
                        blnData = False
                    Next

                    '2019/04/23
                    '判定票印影不備、リーフレット印影不備件、リーフレット印影不備枚の設定
                    sheet(1, 16).Value = iCheckupCount
                    sheet(1, 17).Value = iLeafletCount
                    sheet(1, 18).Value = iLeafTotalCount
                    ...
                    '2019/04/23
                    '判定票印影不備、リーフレット印影不備をセット
                    sheet(21, 1).Value = iCheckupCount
                    sheet(22, 1).Value = iLeafletCount
