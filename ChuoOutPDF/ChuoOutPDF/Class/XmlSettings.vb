...
#Region "コンストラクタ"
	...
	Public Sub New()
		...
		'出力関連
		_HeaderFile = "C:\ChuoTemp\01_Input\test.txt"
		_WorkFolder = "C:\ChuoTemp\02_Work"
		_OutputFolder = "C:\ChuoTemp\03_Output"
		_LogFolder = "C:\ChuoTemp\04_Log"
		_FlagString = "A"

		'SQLServer接続用
		_DataSource = "INTRA-PDC00\INTRASQL"
		_InitialCatalog = "chuo-u_magagine"
		_UserID = "sa"
