...
Module DefaultModule
	...
	Public Sub SetComboValue(ByVal cmb As ComboBox, ByVal dt As DataTable, Optional ByVal IsAll As Boolean = True, Optional ByVal IsCity As Boolean = False)
		...
		If IsCity Then
			...
			If IsAll Then
				...
				For iRow As Integer = 0 To dt.Rows.Count - 1
					...
					elm(iRow + 1).NAME = dt.Rows(iRow)(0) & " " & dt.Rows(iRow)(1)
				Next
			Else
				'「全て」なし
				For iRow As Integer = 0 To dt.Rows.Count - 1
					...
					elm(iRow).NAME = dt.Rows(iRow)(0) & " " & dt.Rows(iRow)(1)
				Next
			End If
		Else
			'その他
