...
#Region "フォームイベント"
	...
	Private Sub frmConnectionProperty_Load(sender As Object, e As EventArgs) Handles MyBase.Load
		...
		Try
			...
			'AddHandler txtServer.TextChanged, AddressOf txt_TextChanged
			'AddHandler txtInitialCatalog.TextChanged, AddressOf txt_TextChanged
			'AddHandler txtUser.TextChanged, AddressOf txt_TextChanged
			'AddHandler txtPassword.TextChanged, AddressOf txt_TextChanged
