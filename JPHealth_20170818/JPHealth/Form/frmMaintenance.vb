...
#Region "オブジェクトイベント"
    ...
    Private Sub btnImport_Click(sender As Object, e As EventArgs) Handles btnImport.Click
        ...
        If MessageBox.Show("局所マスタを洗い替えします" & vbNewLine & "※除外リストには追記します" & vbNewLine & "よろしいですか？", "確認", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
            Exit Sub
        End If
	...
	Private Sub btnLotUpdate_Click(sender As Object, e As EventArgs) Handles btnLotUpdate.Click
		...
		If MessageBox.Show("選択したロットの削除フラグを更新します" & vbNewLine & "よろしいですか？", "確認", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
			Exit Sub
		End If
