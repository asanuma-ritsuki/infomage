...
#Region "プライベートメソッド"
    ...
    Private Function RegistValue() As Boolean
        ...
        Dim iRow As Integer = CType(Me.Owner, frmEntry).C1FGridMokuji.Row
		Dim iCol As Integer = CType(Me.Owner, frmEntry).C1FGridMokuji.Col
		'改行は空文字にリプレースする
		CType(Me.Owner, frmEntry).C1FGridMokuji(iRow, iCol) = Trim(Me.txtItemEdit.Text.Replace(vbCrLf, ""))
		CType(Me.Owner, frmEntry).C1FGridMokuji.AutoSizeRow(iRow)
        Return True
