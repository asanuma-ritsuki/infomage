...
Module PlaySound
    ...
    Private Function PlaySound(ByVal pszSound As IntPtr, _
    ...
    Public Sub PlayWaveSound(ByVal strm As System.IO.Stream)
        ...
        'GCによって移動されないようにする
        gcHandle = System.Runtime.InteropServices.GCHandle.Alloc( _
            waveBuffer, System.Runtime.InteropServices.GCHandleType.Pinned)

        '非同期再生する
        PlaySound(gcHandle.AddrOfPinnedObject(), IntPtr.Zero, _
