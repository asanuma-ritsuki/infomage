...
Module DefaultModule
	...
	Public Function GetFilesMostDeep(ByVal strRootPath As String, ByVal strPatterns() As String) As String()
		...
		For Each strFilePath As String In System.IO.Directory.GetFiles(strRootPath, "*")
			For Each strPattern As String In strPatterns
				...
				If "*" & System.IO.Path.GetExtension(strFilePath).ToLower = strPattern Then
	...
	Public Sub OutputImportLog(ByVal lstResult As ListBox, ByVal strOutputFile As String)

		Dim strDate As String = Date.Now.ToString("yyyyMMdd_HHmmss")
		Dim strOutputImportLog As String = strOutputFile
	...
	Public Sub OutputCSVFile(ByVal C1FGridResult As C1FlexGrid, ByVal strFileName As String)
		...
		Try
			...
			'End If
			Using sw As New System.IO.StreamWriter(strFileName, False, System.Text.Encoding.GetEncoding("Shift-JIS"))
				Dim strWriteLine As String = ""

				For iRow As Integer = 0 To C1FGridResult.Rows.Count - 1
					For iCol As Integer = 0 To C1FGridResult.Cols.Count - 1
						If iCol = 1 Then
							strWriteLine = C1FGridResult(iRow, iCol)
						Else
							strWriteLine &= "," & C1FGridResult(iRow, iCol)
						End If
					Next
	...
	''' <param name="C1FGridResult"></param>
	''' <param name="strFileName"></param>
	Public Sub OutputCSVFileNoGood(ByVal C1FGridResult As C1FlexGrid, ByVal strFileName As String)
